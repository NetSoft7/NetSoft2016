...
namespace CapaDatos_LorealPro
{
    public class Conexion
    {
        ...
        private void TipoDato(CapaDatos_LorealPro.EnumTipoDato tipo, ref SqlParameter parametro, CapaDatos_LorealPro.TipoDato valor)
        {
            if (tipo == CapaDatos_LorealPro.EnumTipoDato.Tipodecimal)
            {
		        parametro.SqlDbType = SqlDbType.Decimal;
		        parametro.Value = valor.DecimalValor;
	        }

            if (tipo == CapaDatos_LorealPro.EnumTipoDato.CadenaTexto)
            {
		        parametro.SqlDbType = SqlDbType.NVarChar;
		        parametro.Value = valor.CadenaTexto;
	        }
            if (tipo == CapaDatos_LorealPro.EnumTipoDato.Entero)
            {
		        parametro.SqlDbType = SqlDbType.Int;
		        parametro.Value = valor.Entero;
	        }
            if (tipo == CapaDatos_LorealPro.EnumTipoDato.Fecha)
            {
       ...
       public void agregarParametro(CapaDatos_LorealPro.EnumTipoDato tipo, CapaDatos_LorealPro.TipoDato valor, string nombre)
       {
	        Exito = true;
	        try {
