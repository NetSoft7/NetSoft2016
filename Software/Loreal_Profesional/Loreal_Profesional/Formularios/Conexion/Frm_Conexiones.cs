...
namespace Loreal_Profesional
{
    ...
    {
        const string NombreProyecto = "PuntodeVenta";
        ...
        {
            btnGuardar.Image = imageCollection1.Images[0];
            btnProbar.Image  = imageCollection1.Images[1];
        }
        ...
        private void Frm_Conexiones_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                valDB = DesencriptarTexto.Desencriptar(RegOut.GetSetting(NombreProyecto, "ConexionSQL", "DBase"));
                valLogin = DesencriptarTexto.Desencriptar(RegOut.GetSetting(NombreProyecto, "ConexionSQL", "User"));
            ...
            {
                {
                    ...
                    try
                    {
                        ...
                        conn.Open();
                        RegIn.SaveSetting(NombreProyecto, "ConexionSQL", "Server", EncriptarTexto.Encriptar(txtServer.Text));
                        RegIn.SaveSetting(NombreProyecto, "ConexionSQL", "DBase", EncriptarTexto.Encriptar(txtDB.Text));
                        RegIn.SaveSetting(NombreProyecto, "ConexionSQL", "User", EncriptarTexto.Encriptar(txtLogin.Text));
                        RegIn.SaveSetting(NombreProyecto, "ConexionSQL", "Password", EncriptarTexto.Encriptar(txtPassword.Text));
